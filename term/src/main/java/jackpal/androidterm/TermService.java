...
public class TermService extends Service implements TermSession.FinishCallback
{
    ...
    public void onCreate() {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            android.app.NotificationChannel channel = new android.app.NotificationChannel("terminal_service_channel", "Terminal Service", android.app.NotificationManager.IMPORTANCE_LOW);
            ...
            builder.setChannelId("terminal_service_channel");
        }
    ...
    private final class RBinder extends ITerminal.Stub {
        ...
        public IntentSender startSession(final ParcelFileDescriptor pseudoTerminalMultiplexerFd,
            ...
            if (android.os.Binder.getCallingUid() != getApplicationInfo().uid) {
                return null;
            }
                        ...
                        new Handler(Looper.getMainLooper()).post(new Runnable() {
                            ...
                            public void run() {
                                ...
                                try {
                                    ...
                                    if (settings.getHomePath() == null || settings.getHomePath().isEmpty()) {
                                        settings.setHomePath(getApplicationContext().getFilesDir().getAbsolutePath());
                                    }
