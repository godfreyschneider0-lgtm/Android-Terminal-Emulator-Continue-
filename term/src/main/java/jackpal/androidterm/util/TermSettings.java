...
public class TermSettings {
    ...
    private static final String FONTPATH_KEY = "font_path";
    ...
    public void readPrefs(SharedPreferences prefs) {
        ...
        mFontPath = readStringPref(FONTPATH_KEY, mFontPath);
        
        // Termux-like automatic font path fallback
        if (mFontPath == null || mFontPath.isEmpty()) {
            java.io.File termFont = new java.io.File(mHomePath, ".term/font.ttf");
            if (termFont.exists() && termFont.canRead()) {
                mFontPath = termFont.getAbsolutePath();
            }
        }
