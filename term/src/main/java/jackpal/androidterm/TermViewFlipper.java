...
public class TermViewFlipper extends ViewFlipper implements Iterable<View> {
    ...
    private void adjustChildSize() {
        if (android.os.Build.VERSION.SDK_INT >= 21) {
            // On modern Android, WindowInsets and standard FrameLayout measurement handle this correctly.
            // Using getWindowVisibleDisplayFrame breaks edge-to-edge layout.
            return;
        }
        updateVisibleRect();
        Rect visible = mVisibleRect;
