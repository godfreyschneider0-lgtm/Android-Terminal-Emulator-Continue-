...
public class TermSession {
    ...
    public void write(byte[] data, int offset, int count) {
        android.util.Log.i("TermSession", "Writing " + count + " bytes: " + new String(data, offset, count));
        try {
            while (count > 0) {
    ...
    protected void processInput(byte[] data, int offset, int count) {
        android.util.Log.i("TermSession", "Received " + count + " bytes: " + new String(data, offset, count));
